...
**Gust of wind** in Train & inspect flight applies a physical velocity/angular-velocity impulse to flying chefs and the carried knife. The learned controller must correct it. Short trails record actual free-flight positions, and an arrow on the inspected active chef shows its applied force; neither changes motion.
